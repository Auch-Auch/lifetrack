  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-4">
      <div>
        ...
        <select
          {...register('skillId')}
          className="w-full px-3 py-2 rounded-[var(--radius)] bg-[hsl(var(--background))] border border-[hsl(var(--border))] text-[hsl(var(--foreground))] focus:outline-none focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-transparent text-sm"
          disabled={!!skillId}
        >
          {skills.map(skill => (
      ...
      <div>
        ...
        <textarea
          {...register('notes')}
          className="w-full px-3 py-2 rounded-[var(--radius)] bg-[hsl(var(--background))] border border-[hsl(var(--border))] text-[hsl(var(--foreground))] placeholder:text-[hsl(var(--muted-foreground))] focus:outline-none focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-transparent resize-none text-sm"
          rows={3}
